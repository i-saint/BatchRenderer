...
public class ProceduralGBufferTest : MonoBehaviour
{
    ...
    void Awake()
    {
        m_renderer = GetComponent<ProceduralGBuffer>();
    ...
    void DataTransfer_ReserveAndWrite(Range r)
    {
        ...
        int reserved_index;
        int reserved_num;
        ProceduralGBuffer.InstanceData data = m_renderer.ReserveInstance(num, out reserved_index, out reserved_num);
